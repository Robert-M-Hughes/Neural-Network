function[net]=backprop(x,y,desired_error,Learning_Rate,hidden_layers,plotting)
%***
...
s1=datascale(s1,0,1);% input  data scalling 
s2=datascale(s2,0,1);% output data scalling
...
[weights]=weightsB(network_architecture,Number_W);
